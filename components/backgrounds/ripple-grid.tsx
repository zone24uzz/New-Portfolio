...
// RippleGrid — WebGL shader background from ReactBits
// Source: https://www.reactbits.dev/backgrounds/ripple-grid
...
void main() {
  ...
  gl_FragColor = vec4(color * gridColor * finalFade * opacity, alpha);
      ...
      containerRef.current.addEventListener("mouseenter", () => { mouseInfluenceRef.current = 1.0 })
      containerRef.current.addEventListener("mouseleave", () => { mouseInfluenceRef.current = 0.0 })
      resize()
